      ...
      <div className="container mx-auto mt-8">
        <div className="w-full overflow-x-auto md:w-8/12 lg:w-6/12 mx-auto bg-white shadow-lg rounded-2xl p-6 border border-gray-200">
          <div className='border border-gray-300 p-5'>
            <form className="">
              ...
              <button
                onClick={addTask}
                type="button"
                className="px-6 py-2 mt-2 w-full bg-cyan-600 w-100 text-white font-semibold rounded-lg"
              >
                 Add
              </button>
            </form>
          ...
          <div className="flex justify-evenly gap-4 mt-5">
            <button onClick={() => setFilter("all")} className="w-40 p-2  bg-cyan-600 text-white rounded-lg font-semibold">
              All
            </button>
            <button onClick={() => setFilter("pending")} className="w-40 p-2 bg-cyan-600 text-white rounded-lg font-semibold">
              Pending
            </button>
            <button onClick={() => setFilter("completed")} className="w-40 p-2 bg-cyan-600 text-white rounded-lg font-semibold">
              Completed
            </button>
          </div>
