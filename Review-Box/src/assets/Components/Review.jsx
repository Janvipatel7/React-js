...
const Review = () => {
    ...
    return (
        <div className={`container mx-auto my-5 px-4 ${allData.length === 0 ? "justify-center items-center" : ""}`}>
            ...
            <div className='flex flex-wrap gap-5 justify-center mt-10'>
                {allData.map((review, index) => (
                    <div key={index} className="bg-gradient-to-br from-[#b4857d] to-[#b4857d] text-white p-4 rounded-xl shadow-md ">
                        <div className=" font-semibold text-2xl">{review.name}</div>
                        <div className="opacity-90 mt-1 text-1xl">{review.date}</div>
                        ...
                        <div className='flex gap-6'>
                            <button className="text-[#b4857d] bg-white hover:bg-[#b4857d] hover:text-white transition-all duration-300 ease-in-out border border-[#b4857d] font-medium rounded-lg text-sm px-5 py-2.5 text-center">Edit</button>
                            <button className="text-[#b4857d] bg-white hover:bg-[#b4857d] hover:text-white transition-all duration-300 ease-in-out border border-[#b4857d] font-medium rounded-lg text-sm px-5 py-2.5 text-center">Delete</button>
                        </div>
                    </div>
                ))}
            </div>
